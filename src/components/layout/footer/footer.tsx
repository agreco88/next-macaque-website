...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-neutral-950  to-orange-950">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:pt-24 lg:px-8 ">
        ...
        <div className="mt-12 sm:mt-24 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm/6 text-gray-400 md:order-1 md:mt-0">
            &copy; 2025 MACAQUE™ Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
