...
export default function HeaderLogo() {
	...
	return (
		<div className="flex items-center">
			...
			<Link href={`/${locale}`} className="hidden md:flex flex-col items-center gap-4">
				<Image
					...
					priority
				/>{" "}
				<p className="sr-only uppercase text-xs tracking-tight font-bold">MACAQUE™ PROTEIN BARS</p>
			</Link>
