...
export default function HomePageHero() {
	...
	return (
		<section className="relative min-h-dvh flex bg-black text-white overflow-hidden">
			...
			<div className="relative container mx-auto z-10 w-full  px-4 sm:px-8 lg:px-0 flex justify-center sm:justify-start">
				<div className="sm:max-w-2xl flex flex-col gap-4 sm:gap-6 items-start  w-full md:justify-center justify-around text-left pt-24">
					<div className="flex flex-col gap-8 justify-center text-center sm:text-start">
						<div className="flex flex-col gap-2 max-w-xl  items-center sm:items-start">
							<span className="text-xl sm sm:text-xl text-gray-200  flex gap-2  uppercase tracking-wide">
								{isMounted && <SplitText text={hero("main")} />}
							</span>

							<h1 className="text-3xl text-pretty sm:text-4xl text-center sm:text-start font-bold uppercase  md:text-white md:border-l-[1px] border-orange-400 md:pl-3 leading-tight">
