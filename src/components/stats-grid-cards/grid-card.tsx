  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        {/* Title */}
        <motion.h2
          className="relative z-10 text-xl sm:text-2xl uppercase leading-tight tracking-tight transform-gpu will-change-transform"
      ...
      {children && (
        <div className="relative z-10 mt-3">
          {typeof children === "function"
            ? (children as (a: boolean) => ReactNode)(active)
            : children}
        </div>
      )}
